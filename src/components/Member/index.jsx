      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-6">
            ...
            <p>Gold (3 tháng)</p>
            <p className="mt-2 text-sm text-zinc-400">Hạn: 30/06/2026</p>
          </div>
          <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-6">
            <h2 className="text-xl font-bold mb-2">Huấn luyện viên</h2>
            <p>Ngô Anh Tuấn</p>
            <p className="mt-2 text-sm text-zinc-400">Thời gian: 3 buổi/tuần</p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-6 mb-8">
          ...
          <ul className="list-disc ml-5 text-zinc-300">
            <li>Thứ 2, 18:00 - Cardio & Sức Mạnh</li>
            <li>Thứ 4, 18:00 - Cơ bụng & Cơ lưng</li>
            <li>Thứ 6, 18:00 - Đầu & Vai</li>
          </ul>
        </div>
